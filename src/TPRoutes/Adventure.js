...
const Adventure = () => {
  ...
  useEffect(()=>{
    ...
    const getData=async()=>{
      try{
        const response=await axios.get('https://the-india-tourism.onrender.com/pages/packs')
  ...
  return (
    ...
    <img src=" https://www.theindiatourism.com/images/India-Adventure-Tours.jpg"  style={{height:"60vh",width:"100vw"}}   alt='Not found' />
