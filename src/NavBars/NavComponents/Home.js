...
const location=useLocation();
  useEffect(()=>{
    ...
    const fetchData=async()=>{
      try{
        const response=await axios.get('https://the-india-tourism.onrender.com/pages/packages')
...
useEffect(()=>{
  const getData=async()=>{
    try{
      const response=await axios.get('https://the-india-tourism.onrender.com/pages/places')
...
<img src=" https://www.theindiatourism.com/images/tourism-india.webp" alt='Not Found' />
      </div>
...
Foreign tourists who fly to India, You are certainly in for a surprise, particularly for the first time. Things can seem a little messy, overwhelming, and out of reach before you start to become attuned to the way of life in this diverse country. You will better plan for the trip ahead by becoming acquainted with the terrain, climate, history, languages and other important pieces of knowledge. Here are a few specifics that would be helpful.
  ...
  <br/><br/><br/>
  <h3 style={{marginTop:"1.5rem",marginBottom:"1.4rem"}}>Find Your Ideal Tour Packages</h3> 
  <br/>
  <p className='Font-Small justify' style={{marginTop:"1.5rem"}}>
...
Travel in India is like nothing you’ve ever experienced, from the magnificence Taj Mahal to the highlights of Kerala, Goa and India, this is a great trip for first-time visitors as it encompasses all of the major tourist destinations.
  ...
  <div className='DynamicWrapper' style={{marginBottom:"1rem"}}> 
   ...
   <img src='https://img.freepik.com/free-photo/fresh-gourmet-meal-beef-taco-salad-plate-generated-by-ai_188544-13382.jpg?size=626&ext=jpg&ga=GA1.2.980724779.1708416303&semt=ais' alt='Not Found' className='CardImgWrapper'/>
   ...
   <h2 className='Font-vSmall'>Solo India Tours</h2>
   </NavLink></div>
  ...
  <h3 style={{marginTop:"1.5rem" ,marginBottom:"1.4rem"}}>Find Your Perfect Holiday Destination</h3> 
  <p className='Font-Small justify' style={{marginTop:"1.5rem"}}>
...
{/* <NavLink to='/stateIndividual'> */}
  ...
  <h3 style={{marginTop:"1.5rem",marginBottom:"1.4rem"}}>Choose Your Style of Tour Packages</h3> 
  <p style={{marginTop:"1.5rem"}} className='Font-Small justify'>
...
Our collection of tour are themed by a style to help you get the most out of your wonderful holiday in India whether you're looking for a small group tour, private tailor made holiday to see India, These packages are meant to cater every of your interest, and that too without hampering your comfort in the travel. The intriguing land of India has so much to explore. 
  ...
  <div className='DynamicWrapper'> 
   ...
   <img src='https://www.theindiatourism.com/images/indiaHoneymoonTours.webp' alt='Not Found' className='CardImgWrapper'/>
   <h2 className='Font-vSmall'>Honey Moon Tours</h2>
   </NavLink>
</div>
<div className='CardWrapper'>
   <NavLink to='/family'>
   <img src='https://www.theindiatourism.com/images/FamilyHolidays.webp' alt='Not Found' className='CardImgWrapper'/>
   <h2 className='Font-vSmall'>Family Holidays Tours</h2>
   </NavLink></div>
   <div className='CardWrapper'>
   <NavLink to='/adventure'>

   <img src='https://www.theindiatourism.com/images/AdventureTours.webp' alt='Not Found' className='CardImgWrapper'/>
   <h2 className='Font-vSmall'>Adventure Tours</h2>
   </NavLink></div>
   <div className='CardWrapper'>
    <NavLink to='/luxury'>
   <img src='https://www.theindiatourism.com/images/IndiaLuxuryTours.webp' alt='Not Found' className='CardImgWrapper'/>
   <h2 className='Font-vSmall'>India Luxury Tours</h2>
   </NavLink></div>
