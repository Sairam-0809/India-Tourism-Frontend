...
// const handleLogin=()=>{
//   try{
//     const res= axios.post('https://the-india-tourism.onrender.com/pages/login',{email,password})
//     .then((res)=>{
...
// https://indiatourismbknd.onrender.com/pages/register 
...
const Login = () => {
  ...
  const handleLogin = async () => {
    try {
      const res = await axios.post(
        'https://the-india-tourism.onrender.com/pages/login',
        { email, password }
      );
  ...
  return (
    // <div className='LoginWrapper'>
    //   {/* <div className='LoginIMG'>
    //     <img src="https://www.theindiatourism.com/images/the-india-tourism.jpg" alt='Login' id='LoginIMG' />
    //   </div> */}
